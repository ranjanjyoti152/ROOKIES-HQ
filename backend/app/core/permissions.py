...
ROLE_PERMISSIONS = {
    ...
    "work_dashboard":  ["admin", "manager", "editor", "client"],
    "client_portal":   ["admin", "manager", "client"],
...
def get_sidebar_items(user) -> List[dict]:
    ...
    all_items = [
        ...
        {"key": "leads",           "label": "Leads Funnel",    "icon": "Target",           "path": "/leads"},
        ...
        {"key": "client_portal",   "label": "Client Portal",   "icon": "Briefcase",        "path": "/client-portal"},
